-- Create SMS database schema for Damza bulk SMS integration
-- This will store partner-specific SMS settings and SMS notifications
...
SELECT 
    ...
    'topup_confirmation' as template_name,
...
-- 8. Add SMS charges to partner charges system
-- This will be handled in the partner charges table
-- SMS charges will be deducted from wallet per message length
