-- SMS Database Tables Creation Script (Fixed Version)
...
-- 3. Create sms_bulk_campaigns table first
...
-- 4. Create sms_notifications table with bulk_campaign_id column
...
-- 5. Add foreign key constraint for bulk_campaign_id (safe way)
DO $$
BEGIN
    IF NOT EXISTS (
...
-- 8. Insert default SMS templates for existing partners
