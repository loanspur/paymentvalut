...
BEGIN
    ...
    IF EXISTS (
        ...
        RAISE NOTICE 'Creating log_audit_event function for audit_logs table';
    ELSE
        RAISE NOTICE 'Skipping log_audit_event function - required columns not found in audit_logs table';
    END IF;
END $$;

-- Create the audit_logs function outside the DO block
...
BEGIN
    ...
    IF EXISTS (
        ...
        RAISE NOTICE 'Creating log_user_activity function for user_activities table';
    ELSE
        RAISE NOTICE 'Skipping log_user_activity function - required columns not found in user_activities table';
    END IF;
END $$;

-- Create the user_activities function outside the DO block
