-- Create balance monitoring configuration table
-- This will store threshold settings and alert preferences for each partner
...
-- Create balance alerts table to track alert history
